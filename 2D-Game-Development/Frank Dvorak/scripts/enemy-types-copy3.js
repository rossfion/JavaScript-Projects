document.addEventListener('DOMContentLoaded', function () {
	...
	class Enemy {
		...
		draw(ctx) {
			ctx.drawImage(this.image, this.frameX * this.spriteHeight, 0, this.spriteHeight, this.spriteHeight, this.x, this.y, this.width, this.height);
		}
	}
	...
	class Worm extends Enemy{
		constructor(game){
			...
			this.width = this.spriteHeight/2; // to preserve aspect ratio
			...
			/* this outputs the HTML reference to the img tag with its ID and other attributes. It appears to be a way of saying document.getElementById = ('worm')*/
	...
	class Spider extends Enemy{
		...
		// to have spiders descending on a line
		draw(ctx){
			ctx.beginPath();
