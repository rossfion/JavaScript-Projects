...
export class Rolling extends State{
    ...
    handleInput(input){
        ...
        if(!input.includes('Enter') && this.game.player.onGround()) {
            ...
            this.game.player.setState(states.FALLING, 1);
            // to get the rolling effect by pressing two keys simultaneously
...
export class Diving extends State{
    ...
    handleInput(input){
        ...
        if(this.game.player.onGround()) {
            this.game.player.setState(states.RUNNING, 1);
            // to create a splash of 30 particles
            for(let i = 0; i < 30; i++){
                this.game.particles.unshift(new Splash(this.game, this.game.player.x + this.game.plater.width * 0.5, this.game.player.y  + this.game.plater.height));
            }
